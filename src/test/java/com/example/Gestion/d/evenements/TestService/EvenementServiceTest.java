...
import com.example.Gestion.d.evenements.services.*;
...
class EvenementServiceTest {
    ...
    void testCapaciteMaxAtteinte() throws Exception {
        ...
        Evenement evenement = evenementService.creerEvenement(
                "conference", "E001", "Small Event",
                LocalDateTime.now().plusDays(10), "Small Venue", 1, params
        );

        Participant p1 = new Participant("P001", "User1", "user1@example.com");
        Participant p2 = new Participant("P002", "User2", "user2@example.com");
